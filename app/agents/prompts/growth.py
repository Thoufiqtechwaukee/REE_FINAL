...
_OUTPUT_SCHEMA = json.dumps(
    {
        "dimensions": {
            "career_progression": {"label": "NONE|LOW|MODERATE|HIGH|EXCEPTIONAL", "note": "string"},
            "responsibility_growth": {"label": "NONE|LOW|MODERATE|HIGH|EXCEPTIONAL", "note": "string"},
            "technical_growth": {"label": "NONE|LOW|MODERATE|HIGH|EXCEPTIONAL", "note": "string"},
            "skill_alignment": {"label": "NONE|LOW|MODERATE|HIGH|EXCEPTIONAL", "note": "string"},
            "ownership_scope": {"label": "NONE|LOW|MODERATE|HIGH|EXCEPTIONAL", "note": "string"},
            "leadership": {"label": "NONE|LOW|MODERATE|HIGH|EXCEPTIONAL", "note": "string"},
            "continuity": {"label": "NONE|LOW|MODERATE|HIGH|EXCEPTIONAL", "note": "string"},
            "role_domain_evolution": {"label": "NONE|LOW|MODERATE|HIGH|EXCEPTIONAL", "note": "string"},
            "current_state": {"label": "NONE|LOW|MODERATE|HIGH|EXCEPTIONAL", "note": "string"},
        },
        "observations": ["string"],
